...
//#define OUTPUT_SAW_TEST /*!< use this to test the audio output by creating a sawtooth test signal */
...
#if (defined ARDUINO_ARCH_RP2040) && (defined __ARM_FEATURE_DSP)
//#define PICO_AUDIO_I2S /*!< use this when a DAC is connected via I2S */
#define RP2040_AUDIO_PWM /*!< use this when audio should be generated by PWM outputs */
#endif
